  ...
  return (
    ...
    >
      <div className="flex flex-col items-center ">
        <h1
          className="text-3xl text-center font-light text-gray-600 dark:text-white-400 mt-6
        ...
        />
        <span
          className="mt-2 mb-6 dark:text-gray-400 transition
      ...
      <ul>
            ...
            >
              <Link to="/createTicket">
                <button className="focus:text-gray-500 w-full transition duration-500 ease-in-out text-gray-900">
                  <span className="flex items-center">
                    <svg class="h-4 w-4 fill-current" viewBox="0 0 18 18">
        ...
        <li
          className="pl-8 py-2 font-semibold text-gray-500 dark:text-gray-400
				border-gray-500 hover:bg-gray-200 mb-2 transition
				duration-500 ease-in-out"
        >
          <button className="focus:text-gray-500 w-full transition duration-500 ease-in-out text-gray-900">
